...
const SECTIONS: { title: string; paragraphs: string[] }[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "我们不会向任何第三方出售你的个人信息。",
      "在以下必要场景下，我们可能与第三方共享部分信息：履行订单时，我们需要向生产合作方与物流服务商提供收件必要信息（收件人、电话、地址、商品规格）；使用第三方服务支持我们的核心功能（例如 Google 提供的 AI 生成服务、云存储服务）时，必要的脱敏请求数据会发送给服务商；根据法律法规的要求或有权机关的合法请求。",
  ...
  },
  {
    title: "AI 数据使用",
    paragraphs: [
      "你在设计页输入的文字描述会被发送给 AI 服务（当前为 Google Gemini 3 Pro Image 模型）用于生成印花图案。描述本身与生成的图片 URL 会与你的账号绑定保存在我们的数据库中，以便你查看历史设计与下单。",
