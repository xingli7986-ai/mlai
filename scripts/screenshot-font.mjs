...
const OUT = path.resolve("design/screenshots/font-after");
...
const PAGES = [
  ...
  { name: "05-studio-join", url: "/studio/join" },
  { name: "06-my", url: "/my" },
];
...
async function snap(page, dir, name, url) {
  try {
    ...
    // Give fonts time to download + lay out, since Noto Sans SC is large.
